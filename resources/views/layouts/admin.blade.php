...
<head>
    ...
    <title>RENT·AI – Admin Panel</title>
    ...
    <style>
        ...
        :root {
            ...
            --surface-active: rgba(79, 110, 247, 0.12);
            ...
            --text-3: #50596a;
            --accent: #4f6ef7;
            --accent-lo: rgba(79, 110, 247, 0.15);
            --green: #1fcfaa;
            --green-lo: rgba(31, 207, 170, 0.12);
            --amber: #f0b429;
            --amber-lo: rgba(240, 180, 41, 0.12);
            --red: #f0445a;
            --red-lo: rgba(240, 68, 90, 0.12);
            --purple: #9b72f7;
