...
class WalletController extends Controller
{
    ...
    public function initiateRecharge(Request $request)
    {
        try {
            ...
            $orderData = [
                ...
                'order_meta' => [
                    'return_url' => url('/wallet?order_id={order_id}'),
    ...
    /**
     * Check payment status (polling endpoint for mobile app & return page)
     * Now PUBLIC – no authentication required (order_id is the identifier)
     */
    public function checkPaymentStatus(Request $request)
    {
        try {
            ...
            // Find transaction by order_id (no user check)
            ...
            // Rate limiting based on order_id (prevents abuse)
            $rateLimitKey = 'payment_status_'.$orderId;
     ...
     */
    private function exportStatementCSV(array $statement): Response
    {
