        ...
        try {
            ...
            foreach ($shops as $shop) {
                try {
                    ...
                    Log::error("Error loading stats for shop {$shop->id}: " . $e->getMessage());
                    // Set default values to prevent view errors
                    $shop->total_rentals = 0;
                    $shop->active_rentals = 0;
                    $shop->completed_rentals = 0;
                    $shop->verifications = 0;
                    $shop->fresh_verifications = 0;
                    $shop->cached_verifications = 0;
                    $shop->total_income = 0;
                    $shop->platform_profit = 0;
                    $shop->recent_rentals = collect();
                    $shop->fleet_vehicles = collect();
                }
            }
